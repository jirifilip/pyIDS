...
for dataset_name, rule_cutoff in dataset_rulenum.items():
    ...
    for train_file, test_file in list(zip(train_files, test_files))[7:]:
        ...
        benchmark_data_df.to_csv("output_data/cba_auc_interpretability_coats_benchmark_anneal2.csv")
