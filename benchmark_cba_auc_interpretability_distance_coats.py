...
for dataset_name, rule_cutoff in dataset_rulenum.items():
    ...
    for train_file, test_file in list(zip(train_files, test_files))[:]:
        ...
        def fmax(param_dict):
            ...
            support, confidence = param_dict["support"], param_dict["confidence"]
        ...
        coord_asc = CoordinateAscent(
            ...
            ternary_search_precision=0.005,
            max_iterations=3,
        ...
        benchmark_data_df.to_csv("output_data/cba_auc_interpretability_distance_coats_benchmark.csv")
